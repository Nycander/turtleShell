...
\begin{testcase}{Byte av arbetskatalog}
	...
	\actions{\begin{actionlist}
		...
		\item Exekvera ``\cmdline{pwd}'' och notera resultatet
		\item Exekvera ``\cmdline{cd /etc}''
		\item Exekvera ``\cmdline{pwd}'' och notera resultatet
	\end{actionlist}}
	\result{\begin{checklist}
		\item Första resultatet borde vara samma som värdet på \texttt{HOME}-variabeln.
		\item Andra resultatet borde vara ``/etc''.
	\end{checklist}}
\end{testcase}
